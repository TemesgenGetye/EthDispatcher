            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
              <div className="text-center mb-4 md:mb-6">
                <div className="w-16 h-16 md:w-24 md:h-24 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
                  <Building2 className="w-8 h-8 md:w-12 md:h-12 text-blue-600" />
                </div>
                ...
                <span
                  className={`inline-block px-2 md:px-3 py-1 rounded-full text-xs font-medium mt-2 ${
                    user.status === "active"
          ...
          <div className="lg:col-span-2 space-y-4 md:space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
              <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4 flex items-center">
                <Building2 className="w-4 h-4 md:w-5 md:h-5 text-blue-600 mr-2" />
                Company Information
              </h3>
